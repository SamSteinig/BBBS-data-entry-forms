...
<% if HelpID="Time" then %>
	...
	<span class = "formMain">
	<p>
	Select whether the employee is full or part time.<br><br>
    If employee is Part Time, enter what fraction of Full Time employee he or she is (FTE*). 
    <BR>If the employee is Full Time, 1.0 FTE value will automatically be assigned.<br><br>
     *FTE (Full Time Equivalent)-is % of Full Time<br>
       e.g. where 40 hrs = Full Time and employee works 20, FTE = 20/40 = 0.5<br>
       Or where 35 hours = Full time and employee works 20 hours, FTE = 20/35 = 0.57
	</p>
