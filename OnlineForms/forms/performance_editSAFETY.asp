...
{	
	...
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceCBIandFB.value)))
		{alert(document.frmPerformance.frmPerformanceCBIandFB.value + " is an invalid number");document.frmPerformance.frmPerformanceCBIandFB.focus();}		
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceSBIandFB.value)))
		{alert(document.frmPerformance.frmPerformanceSBIandFB.value + " is an invalid number");document.frmPerformance.frmPerformanceSBIandFB.focus();}		
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceOSBInotFB.value)))
		{alert(document.frmPerformance.frmPerformanceOSBIandFB.value + " is an invalid number");document.frmPerformance.frmPerformanceOSBIandFB.focus();}				
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceCBInotFB.value)))
		{alert(document.frmPerformance.frmPerformanceCBInotFB.value + " is an invalid number");document.frmPerformance.frmPerformanceCBInotFB.focus();}						
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceSBInotFB.value)))
		{alert(document.frmPerformance.frmPerformanceSBInotFB.value + " is an invalid number");document.frmPerformance.frmPerformanceSBInotFB.focus();}								
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceOSBInotFB.value)))
		{alert(document.frmPerformance.frmPerformanceOSBInotFB.value + " is an invalid number");document.frmPerformance.frmPerformanceOSBInotFB.focus();}								
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceCBFBnotI.value)))
		{alert(document.frmPerformance.frmPerformanceCBFBnotI.value + " is an invalid number");document.frmPerformance.frmPerformanceCBFBnotI.focus();}										
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceSBFBnotI.value)))
		{alert(document.frmPerformance.frmPerformanceSBFBnotI.value + " is an invalid number");document.frmPerformance.frmPerformanceSBFBnotI.focus();}										
	else if(!(onlyInteger.test(document.frmPerformance.frmPerformanceOSBFBnotI.value)))
		{alert(document.frmPerformance.frmPerformanceOSBFBnotI.value + " is an invalid number");document.frmPerformance.frmPerformanceOSBFBnotI.focus();}												
...
<% If FBIAgency = 1 and ((y > 2002 and m < 7) or (y = 2002 and m > 8) ) Then %>	
		...
		<tr>				
			<td colspan="7" class="formHeaderMedium">FAITH-BASED / INCARCERATED PARENTS REPORT</td>
		</tr>
		
		<tr>
			<td colspan="7" class="formMain" align="center">Based on the <strong>OPEN/ACTIVE</strong> match numbers above, answer the following questions:</td>
		</tr>
		...
		<tr>
			...
			<td align="center" valign="middle" class="formMain">School Based</td>
			<td align="center" valign="middle" class="formMain">Other Site Based</td>
			<td align="center" valign="middle" class="formMain" colspan="3">&nbsp;</td>
		</tr>
		
		<tr>
			<td align="left" class="formMain" >Faith-Based Partnerships <strong>And</strong> Children with Incarcerated Parents (as of the last day of &nbsp<b><%= MonthName(Request("m"), False) & " " & Request("y") %></b>)</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("CBIandFB") %><% Else %>0<% End If %>" name="frmPerformanceCBIandFB" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("SBIandFB") %><% Else %>0<% End If %>" name="frmPerformanceSBIandFB" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("OSBIandFB") %><% Else %>0<% End If %>" name="frmPerformanceOSBIandFB" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>			
			
			<td colspan = "3" align="left" valign="middle" class="formMain">&nbsp;</td>
			
		</tr>
		
		
		<tr>
			<td align="left" class="formMain" >Children with Incarcerated Parents <strong>Only </strong>(as of the last day of &nbsp<b><%= MonthName(Request("m"), False) & " " & Request("y") %></b>)</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("CBInotFB") %><% Else %>0<% End If %>" name="frmPerformanceCBInotFB" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("SBInotFB") %><% Else %>0<% End If %>" name="frmPerformanceSBInotFB" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("OSBInotFB") %><% Else %>0<% End If %>" name="frmPerformanceOSBInotFB" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>			
		...
		<tr>
			<td align="left" class="formMain" >Faith-Based Partnerships <strong>Only </strong>(as of the last day of &nbsp<b><%= MonthName(Request("m"), False) & " " & Request("y") %></b>)</td>		
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("CBFBnotI") %><% Else %>0<% End If %>" name="frmPerformanceCBFBnotI" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("SBFBnotI") %><% Else %>0<% End If %>" name="frmPerformanceSBFBnotI" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>
			
			<td colspan = "1" align="left" valign="middle" class="formMain">
				<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("OSBFBnotI") %><% Else %>0<% End If %>" name="frmPerformanceOSBFBnotI" tabindex="14" onchange="checkForIntegerCommas(this.value);">				
			</td>			
