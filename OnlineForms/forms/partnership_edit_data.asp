...
<tr>
	...
	<td align="center" class="formmain">
		<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("AlphaCommunityBased") %><% Else %>0<% End If %>" name="frmPartnershipsAlphaCommunityBased" tabindex="1" onchange="checkForIntegerCommas(this.value);">
	</td>
	...
	<td align="center" colspan="2" class="formmain">
		<input type="radio" name="frmPartnershipsAlphainterest" value=1 checked>Yes
		<input type="radio" name="frmPartnershipsAlphainterest" value=0>No
	</td>
...
<tr>
	...
	<!-- Lions Interest -->
	<td align="center" colspan="2" class="formmain">
		<input type="radio" name="frmpartnershipslionsinterest" value=1 checked>Yes
		<input type="radio" name="frmpartnershipslionsinterest" value=0>No
	</td>	
...
<tr>
	...
	<!-- Rotary Interest -->
	<td align="center" colspan="2" class="formmain">
		<input type="radio" name="frmpartnershipsRotaryinterest" value=1 checked>Yes
		<input type="radio" name="frmpartnershipsRotaryinterest" value=0>No
	</td>		
...
<tr>
	...
	<!-- Kiwanis Interest -->
	<td align="center" colspan="2" class="formmain">
		<input type="radio" name="frmpartnershipsKiwanisinterest" value=1 checked>Yes
		<input type="radio" name="frmpartnershipsKiwanisinterest" value=0>No
	</td>		
...
<tr>
	...
	<!-- Optimist Interest -->
	<td align="center" colspan="2" class="formmain">
		<input type="radio" name="frmpartnershipsOptimistinterest" value=1 checked>Yes
		<input type="radio" name="frmpartnershipsOptimistinterest" value=0>No
	</td>		
...
<tr>
	...
	<!-- AARP Interest -->
	<td align="center" colspan="2" class="formmain">
		<input type="radio" name="frmpartnershipsAARPinterest" value=1 checked>Yes
		<input type="radio" name="frmpartnershipsAARPinterest" value=0>No
	</td>		
...
<tr>
	...
	<select name="frmPartnershipsAlphaRating">
...
<tr>
	...
	<td class="formMain" colspan="5" align="left">	
	<select name="frmPartnershipsLionsRating">
	<option value=0>Not Applicable</option>
	<option value=1 selected>1 - Informal</option>
	<option value=2>2</option>
	<option value=3>3</option>
...
<tr>
	...
	<td class="formMain" colspan="5" align="left">	
	<select name="frmPartnershipsRotaryRating">
	<option value=0>Not Applicable</option>
	<option value=1 selected>1 - Informal</option>
	<option value=2>2</option>
	<option value=3>3</option>
...
<tr>
	...
	<td class="formMain" colspan="5" align="left">	
	<select name="frmPartnershipsKiwanisRating">
	<option value=0>Not Applicable</option>
	<option value=1 selected>1 - Informal</option>
	<option value=2>2</option>
	<option value=3>3</option>
...
<tr>
	...
	<td class="formMain" colspan="5" align="left">	
	<select name="frmPartnershipsOptimistRating">
	<option value=0>Not Applicable</option>
	<option value=1 selected>1 - Informal</option>
	<option value=2>2</option>
	<option value=3>3</option>
...
<tr>
	...
	<td class="formMain" colspan="5" align="left">	
	<select name="frmPartnershipsAARPRating">
	<option value=0>Not Applicable</option>
	<option value=1 selected>1 - Informal</option>
	<option value=2>2</option>
	<option value=3>3</option>
...
<tr>
	...
	<input type="Checkbox" name="frmPartnershipsAlphaFunding" value=1>Funding: Alpha chapter supports BBBS funding efforts<br>
	<input type="Checkbox" name="frmPartnershipsAlphaProgramInitiative" value=1>Program Initiative: Chapter has activities with children on waiting list<br>
	<input type="Checkbox" name="frmPartnershipsAlphaLeadershipInvolvement" value=1>Leadership Involvement: Alpha serves on board, provides agency with professional skills and resources (serves as volunteer)
...
<tr>
	...
	Name:&nbsp;<input type="text" name="frmPartnershipsAlphaUndergradChapterName" size="50" value=" "><br>
	City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="frmPartnershipsAlphaUndergradChapterCity" size="40" value=" "><br>
	State:&nbsp;&nbsp;
	<select NAME="frmPartnershipsAlphaUndergradChapterState">
	  <option value=" "></option>
	  <%
...
<tr>
	...
	<td align="left" colspan="6" class="formMain">
	Name:&nbsp;<input type="text" name="frmPartnershipsAlphaAlumniChapterName" size="50" value=" "><br>
	City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="frmPartnershipsAlphaAlumniChapterCity" size="40" value=" "><br>
	State:&nbsp;&nbsp;
	<select NAME="frmPartnershipsAlphaAlumniChapterState">
	  <option value=" "></option>
	  <%
	  While (NOT StateChoices.EOF)
	  %>
