...
If Request("status") = "editOld" Then
	...
	OpenMatchesCommunityBasedBegin = GetInitialValues("BeginOpenCommunityBased") 
	OpenMatchesSchoolBasedBegin = GetInitialValues("BeginOpenSchoolBased") 	
	OpenMatchesOtherSiteBasedBegin = GetInitialValues("BeginOpenOtherSiteBased") 
	OpenMatchesGroupMentoringBegin = GetInitialValues("BeginOpenGroupMentoring") 	
	OpenMatchesSpecialProgramsMentoringBegin = GetInitialValues("BeginOpenSpecialProgramsMentoring") 	
	OpenMatchesSpecialProgramsNonMentoringBegin = GetInitialValues("BeginOpenSpecialProgramsNonMentoring") 		
	...
	OpenMatchesGroupMentoringInitial = GetInitialValues("OpenMatchesGroupMentoring") 	
	OpenMatchesSpecialProgramsMentoringInitial = GetInitialValues("OpenMatchesSpecialProgramsMentoring") 	
	OpenMatchesSpecialProgramsNonMentoringInitial = GetInitialValues("OpenMatchesSpecialProgramsNonMentoring")
...
' Check for duplicate records
	...
	If(numberOfExisting = 0) Then
		...
		RST("BeginOpenCommunityBased") = Request("frmPerformancePrevOpenComm")
		RST("BeginOpenSchoolBased") = Request("frmPerformancePrevOpenSchool")
		RST("BeginOpenOtherSiteBased") = Request("frmPerformancePrevOpenOther")
		RST("BeginOpenGroupMentoring") = Request("frmPerformancePrevOpenGroup")		
		RST("BeginOpenSpecialProgramsMentoring") = Request("frmPerformancePrevOpenSpecMent")				
		RST("BeginOpenSpecialProgramsNonMentoring") = Request("frmPerformancePrevOpenSpecNonMent")			
...
ElseIf Request("status") = "editSave" Then
	...
	OpenMatchesCommunityBasedBegin = RST("BeginOpenCommunityBased") 
	OpenMatchesSchoolBasedBegin = RST("BeginOpenSchoolBased") 	
	OpenMatchesOtherSiteBasedBegin = RST("BeginOpenOtherSiteBased") 
	OpenMatchesGroupMentoringBegin = RST("BeginOpenGroupMentoring") 	
	OpenMatchesSpecialProgramsMentoringBegin = RST("BeginOpenSpecialProgramsMentoring") 	
	OpenMatchesSpecialProgramsNonMentoringBegin = RST("BeginOpenSpecialProgramsNonMentoring") 		
	...
	OpenMatchesGroupMentoringInitial = RST("OpenMatchesGroupMentoring") 	
	OpenMatchesSpecialProgramsMentoringInitial = RST("OpenMatchesSpecialProgramsMentoring") 	
	OpenMatchesSpecialProgramsNonMentoringInitial = RST("OpenMatchesSpecialProgramsNonMentoring")
...
'		RST("AlphaAlumniChapterState") = Request("frmPerformanceAlphaAlumniChapterState")			
	...
	set Con = Server.CreateObject("ADODB.Connection")
		...
		CommunityDifference = int(trim(Request("frmPerformanceOpenMatchesCommunityBased"))) - OpenMatchesCommunityBasedInitial
		sql_CommunityDifference = "sp_PropagatePerformanceChanges '" & Session("AgencyIDN") & "'," & "'" & right("00" & Int(Request("month")),2) & "/01/" & Int(Request("year")) & "','>','tbl_frmPerformance','OpenMatchesCommunityBased','+','" & CommunityDifference & "'"

		SchoolDifference = int(trim(Request("frmPerformanceOpenMatchesSchoolBased"))) - OpenMatchesSchoolBasedInitial
		sql_SchoolDifference = "sp_PropagatePerformanceChanges '" & Session("AgencyIDN") & "'," & "'" & right("00" & Int(Request("month")),2) & "/01/" & Int(Request("year")) & "','>','tbl_frmPerformance','OpenMatchesSchoolBased','+','" & SchoolDifference & "'"

		OtherDifference = Request("frmPerformanceOpenMatchesOtherSiteBased") - OpenMatchesOtherSiteBasedInitial
		sql_OtherDifference = "sp_PropagatePerformanceChanges '" & Session("AgencyIDN") & "'," & "'" & right("00" & Int(Request("month")),2) & "/01/" & Int(Request("year")) & "','>','tbl_frmPerformance','OpenMatchesOtherSiteBased','+','" & OtherDifference & "'"

		GroupDifference = Request("frmPerformanceOpenMatchesGroupMentoring") - OpenMatchesGroupMentoringInitial
		sql_GroupDifference = "sp_PropagatePerformanceChanges '" & Session("AgencyIDN") & "'," & "'" & right("00" & Int(Request("month")),2) & "/01/" & Int(Request("year")) & "','>','tbl_frmPerformance','OpenMatchesGroupMentoring','+','" & GroupDifference & "'"

		SpecMentDifference = Request("frmPerformanceOpenMatchesSpecialProgramsMentoring") - OpenMatchesSpecialProgramsMentoringInitial
		sql_SpecMentDifference = "sp_PropagatePerformanceChanges '" & Session("AgencyIDN") & "'," & "'" & right("00" & Int(Request("month")),2) & "/01/" & Int(Request("year")) & "','>','tbl_frmPerformance','OpenMatchesSpecialProgramsMentoring','+','" & SpecMentDifference & "'"		

		SpecNonMentDifference = Request("frmPerformanceOpenMatchesSpecialProgramsNonMentoring") - OpenMatchesSpecialProgramsNonMentoringInitial
		sql_SpecNonMentDifference = "sp_PropagatePerformanceChanges '" & Session("AgencyIDN") & "'," & "'" & right("00" & Int(Request("month")),2) & "/01/" & Int(Request("year")) & "','>','tbl_frmPerformance','OpenMatchesSpecialProgramsNonMentoring','+','" & SpecNonMentDifference & "'"
		...
		if GroupDifference <> 0 then		
			Set rs = Con.Execute(sql_GroupDifference)
		end if		
		
		if SpecMentDifference <> 0 then		
			Set rs = Con.Execute(sql_SpecMentDifference)
		end if		
		
		if SpecNonMentDifference <> 0 then	
			Set rs = Con.Execute(sql_SpecNonMentDifference)
		end if		
...
{	
	...
	//alert(document.frmPerformance.frmPerformanceClosedMatchesCommunityBased.value + " test box");
...
//		{alert( "ERROR:\n\nThe sum of your current OPEN PLUS your CLOSED Other Site-Based matches ("+CurOtherOpen+"+"+CurOtherClosed+") must be greater than your previous month's OPEN Other Site-Based matches ("+PrevOpenOther+").  Please correct and re-SAVE.");document.frmPerformance.frmPerformanceOpenMatchesOtherSiteBased.focus();}
	...
	if(document.frmPerformance.frmPerformanceRTBM_UnmatchedChildren.value == "")
		...
		{alert("1 Please complete all form fields");document.frmPerformance.frmPerformanceOpenMatchesCommunityBased.focus();}		
	else if(document.frmPerformance.frmPerformanceOpenMatchesSchoolBased.value == "")
		{alert("2 Please complete all form fields");document.frmPerformance.frmPerformanceOpenMatchesSchoolBased.focus();}
		...
		{alert("3 Please complete all form fields");document.frmPerformance.frmPerformanceClosedMatchesCommunityBased.focus();}
	else if(document.frmPerformance.frmPerformanceClosedMatchesSchoolBased.value == "")
		{alert("4Please complete all form fields");document.frmPerformance.frmPerformanceClosedMatchesSchoolBased.focus();}
	else if(document.frmPerformance.frmPerformanceClosedMatchesOtherSiteBased.value == "")
		{alert("5Please complete all form fields");document.frmPerformance.frmPerformanceClosedMatchesOtherSiteBased.focus();}

//else if(document.frmPerformance.frmPerformanceClosedMatchesGroupMentoring.value == "")
//		{alert("6Please complete all form fields");document.frmPerformance.frmPerformanceClosedMatchesGroupMentoring.focus();}
//	else if(document.frmPerformance.frmPerformanceClosedMatchesSpecialProgramsMentoring.value == "")
//		{alert("7Please complete all form fields");document.frmPerformance.frmPerformanceClosedMatchesSpecialProgramsMentoring.focus();}
//	else if(document.frmPerformance.frmPerformanceClosedMatchesSpecialProgramsNonMentoring.value == "")
//		{alert("8Please complete all form fields");document.frmPerformance.frmPerformanceClosedMatchesSpecialProgramsNonMentoring.focus();}

		
		
		
/*	else if(document.frmPerformance.frmPerformanceCBNumberClosedPrematurely.value == "")
		{alert("9Please complete all form fields");document.frmPerformance.frmPerformanceCBNumberClosedPrematurely.focus();}		
	else if(document.frmPerformance.frmPerformanceSBNumberClosedPrematurely.value == "")
		{alert("10Please complete all form fields");document.frmPerformance.frmPerformanceSBNumberClosedPrematurely.focus();}				
		
	else if(document.frmPerformance.frmPerformanceCBChildParentStatusChange.value == "")
		{alert("11Please complete all form fields");document.frmPerformance.frmPerformanceCBChildParentStatusChange.focus();}				
		
	else if(document.frmPerformance.frmPerformanceCBChildParentStatusChange.value == "")
		{alert("12Please complete all form fields");document.frmPerformance.frmPerformanceCBChildParentStatusChange.focus();}				
	else if(document.frmPerformance.frmPerformanceSBChildParentStatusChange.value == "")
		{alert("13Please complete all form fields");document.frmPerformance.frmPerformanceSBChildParentStatusChange.focus();}						
	else if(document.frmPerformance.frmPerformanceCBChildParentDissatisfaction.value == "")
		{alert("14Please complete all form fields");document.frmPerformance.frmPerformanceCBChildParentDissatisfaction.focus();}						
	else if(document.frmPerformance.frmPerformanceSBChildParentDissatisfaction.value == "")
		{alert("15Please complete all form fields");document.frmPerformance.frmPerformanceSBChildParentDissatisfaction.focus();}			
	else if(document.frmPerformance.frmPerformanceCBVolunteerDissatisfaction.value == "")
		{alert("16Please complete all form fields");document.frmPerformance.frmPerformanceCBVolunteerDissatisfaction.focus();}					
	else if(document.frmPerformance.frmPerformanceSBVolunteerDissatisfaction.value == "")
		{alert("17Please complete all form fields");document.frmPerformance.frmPerformanceSBVolunteerDissatisfaction.focus();}							
	else if(document.frmPerformance.frmPerformanceCBTotalOpened6MonthsAgo.value == "")
		{alert("18Please complete all form fields");document.frmPerformance.frmPerformanceCBTotalOpened6MonthsAgo.focus();}		
	else if(document.frmPerformance.frmPerformanceCBNumberStillOpen.value == "")
		{alert("19Please complete all form fields");document.frmPerformance.frmPerformanceCBNumberStillOpen.focus();}										
	else if(document.frmPerformance.frmPerformanceEnrollmentSatAvgScore.value == "")
		{alert("20Please complete all form fields");document.frmPerformance.frmPerformanceEnrollmentSatAvgScore.focus();}												
	else if(document.frmPerformance.frmPerformanceEnrollmentSatCount.value == "")
		{alert("21Please complete all form fields");document.frmPerformance.frmPerformanceEnrollmentSatCount.focus();}														
	else if(document.frmPerformance.frmPerformanceMatchSatAvgScore.value == "")
		{alert("22Please complete all form fields");document.frmPerformance.frmPerformanceMatchSatAvgScore.focus();}			
	else if(document.frmPerformance.frmPerformanceMatchSatCount.value == "")
		{alert("23Please complete all form fields");document.frmPerformance.frmPerformanceMatchSatCount.focus();}			
	else if(document.frmPerformance.frmPerformanceCBPOEAggregateScore.value == "")
		{alert("24Please complete all form fields");document.frmPerformance.frmPerformanceCBPOEAggregateScore.focus();}	
	else if(document.frmPerformance.frmPerformanceSBPOEAggregateScore.value == "")
		{alert("25Please complete all form fields");document.frmPerformance.frmPerformanceSBPOEAggregateScore.focus();}							
	else if(document.frmPerformance.frmPerformanceCBPOECount.value == "")
		{alert("26Please complete all form fields");document.frmPerformance.frmPerformanceCBPOECount.focus();}	
	else if(document.frmPerformance.frmPerformanceSBPOECount.value == "")
		{alert("27Please complete all form fields");document.frmPerformance.frmPerformanceSBPOECount.focus();}											
*/		
...
<br>
		...
		<tr>
			...
			<tr>
				<td align="center" valign="middle" class="formMain">&nbsp;Transfer Matches&nbsp;<a href="../helpfiles/surveyhelp.asp?HelpID=transfer" onclick="NewWindow(this.href,'name','500','275','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a></td>			
			...
			<input type="hidden" name="frmPerformanceOpenMatchesCommunityBasedBegin" value="<%=OpenMatchesCommunityBasedBegin%>">			
			<input type="hidden" name="frmPerformanceOpenMatchesSchoolBasedBegin" value="<%=OpenMatchesSchoolBasedBegin%>">						
			<input type="hidden" name="frmPerformanceOpenMatchesOtherSiteBasedBegin" value="<%=OpenMatchesOtherSiteBasedBegin%>">
			<input type="hidden" name="frmPerformanceOpenMatchesGroupMentoringBegin" value="<%=OpenMatchesGroupMentoringBegin%>">
			<input type="hidden" name="frmPerformanceOpenMatchesSpecialProgramsMentoringBegin" value="<%=OpenMatchesSpecialProgramsMentoringBegin%>">						
			<input type="hidden" name="frmPerformanceOpenMatchesSpecialProgramsNonMentoringBegin" value="<%=OpenMatchesSpecialProgramsNonMentoringBegin%>">									
			...
			<!-- YTD Children Served -->
			<td align="center" valign="middle" class="formMain"><strong>YEAR TO DATE</strong> - Total number of children matched as of the end of <strong><%= MonthName(Request("m"), False) & " " & Request("y") %></strong></td>			
			<td align="center" valign="middle" bgcolor="#c0c0c0" class="formMain"><input type="text"  class="formMain" size="5" maxlength="10" value="<%=Request("CommunityYTD")%>" name="frmPerformanceCommunityYTD" readonly><br><span class="formSubHead">calculated by system</span></td>
			<td align="center" valign="middle" bgcolor="#c0c0c0" class="formMain"><input type="text"  class="formMain" size="5" maxlength="10" value="<%=Request("SchoolYTD")%>" name="frmPerformanceSchoolYTD" readonly><br><span class="formSubHead">calculated by system</span></td>
			<td align="center" valign="middle" bgcolor="#c0c0c0" class="formMain"><input type="text"  class="formMain" size="5" maxlength="10" value="<%=Request("OtherYTD")%>" name="frmPerformanceOtherYTD" readonly><br><span class="formSubHead">calculated by system</span></td>
			<td colspan="3">&nbsp;</td>
			<!-- end YTD Children Served -->
			<% ' if y > 2004 then %>
			<tr>
				<td align="center" class="formMain" colspan="7"><em><strong><font color="red">NOTE:</font> Revenue Questions Have Been Relocated to the New Monthly Revenue / Expense Form.</strong></em></td>
			</tr>
			<input type="hidden" class="formMain" size="8" maxlength="8" value="<% If say = "edit" Then %><%= GetPerformance("Revenue") %><% Else %>1<% End If %>" name="frmPerformanceRevenue" tabindex="15" >					
			...
			<tr>
				<td align="center" valign="middle" class="formMain">Revenue Booked for This Month</td>
				<td align="center" valign="middle" class="formMain"><input type="text" class="formMain" size="8" maxlength="8" value="<% ' If say = "edit" Then %><% '= GetPerformance("Revenue") %><% 'Else %>0<% 'End If %>" name="frmPerformanceRevenue" tabindex="15" onchange="checkForIntegerCommas(this.value);"></td>
				<td colspan="5">&nbsp;</td>
			</tr>
			<input type="hidden" class="formMain" size="8" maxlength="8" value="<% ' =Request("RevenueYTD")%>" name="frmPerformanceRevenueYTD" readonly>																
			<% ' end if %> 
			-->
