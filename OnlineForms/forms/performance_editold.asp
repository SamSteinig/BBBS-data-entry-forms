...
{	
	...
	if (CurCommTotal.valueOf() < PrevOpenComm)	
		...
		{alert("Average Match Length for Non-School Site-Based matches cannot be greater than 0 if you did not close any matches during the current month.");document.frmPerformance.frmPerformanceAverageMatchLengthOSB.focus();}				

	else if(document.frmPerformance.frmperformanceValidateAML.value == 1 && document.frmPerformance.frmPerformanceAverageMatchLengthOSB.value == 0 && document.frmPerformance.frmPerformanceClosedMatchesOtherSiteBased.value > 0)
		{alert("Average Match Length for Non-School Site-Based matches must be greater than 0 because you closed matches during the current month.");document.frmPerformance.frmPerformanceAverageMatchLengthOSB.focus();}						
...
<br>
		...
		<tr>
			...
			<tr>
				<td align="center" valign="middle" class="formMain">OPEN/ACTIVE&nbsp;matches on&nbsp;the&nbsp;<strong>FIRST</strong>&nbsp;day&nbsp;of <b><%= MonthName(Request("m"), False) & " " & Request("y") %></b></td>
			...
			<tr>
				...
				<td align="center" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("ClosedMatchesCommunityBased") %><% Else %>0<% End If %>" name="frmPerformanceClosedMatchesCommunityBased" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenComm();">
				</td>
				
				<td align="center" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("ClosedMatchesSchoolBased") %><% Else %>0<% End If %>" name="frmPerformanceClosedMatchesSchoolBased" tabindex="4" onchange="checkForIntegerCommas(this.value); addUpOpenSchool();">
				</td>
				
				<td align="center" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("ClosedMatchesOtherSiteBased") %><% Else %>0<% End If %>" name="frmPerformanceClosedMatchesOtherSiteBased" tabindex="6" onchange="checkForIntegerCommas(this.value); addUpOpenNonSchool();">
				</td>
				
				<% if y < 2004 then %>			
				
					<td align="center" valign="middle" class="formMain">
						<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("ClosedMatchesGroupMentoring") %><% Else %>0<% End If %>" name="frmPerformanceClosedMatchesGroupMentoring" tabindex="8" onchange="checkForIntegerCommas(this.value); addUpOpenGroup();">
					</td>
					
					<td align="center" valign="middle" class="formMain">
						<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("ClosedMatchesSpecialProgramsMentoring") %><% Else %>0<% End If %>" name="frmPerformanceClosedMatchesSpecialProgramsMentoring" tabindex="10" onchange="checkForIntegerCommas(this.value); addUpOpenSpecMent();">
					</td>
					
					<td align="center" valign="middle" class="formMain">
						<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("ClosedMatchesSpecialProgramsNonMentoring") %><% Else %>0<% End If %>" name="frmPerformanceClosedMatchesSpecialProgramsNonMentoring" tabindex="12" onchange="checkForIntegerCommas(this.value); addUpOpenSpecNonMent();">
					</td>
			...
			<tr>
				...
				<td align="left" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("NewMatchesCommunityBased") %><% Else %>0<% End If %>" name="frmPerformanceNewMatchesCommunityBased" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenComm();">
				</td>
				<td align="left" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("NewMatchesSchoolBased") %><% Else %>0<% End If %>" name="frmPerformanceNewMatchesSchoolBased" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenSchool();">
				</td>
				<td align="left" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("NewMatchesSiteBasedNonSchool") %><% Else %>0<% End If %>" name="frmPerformanceNewMatchesSiteBasedNonSchool" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenNonSchool();">
				</td>

				<% if Y < 2004 then %>
					<td align="left" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("NewMatchesGroupMentoring") %><% Else %>0<% End If %>" name="frmPerformanceNewMatchesGroupMentoring" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenGroup();">
					</td>
					<td align="left" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("NewMatchesSpecialProgramsMentoring") %><% Else %>0<% End If %>" name="frmPerformanceNewMatchesSpecialProgramsMentoring" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenSpecMent();">
					</td>
					<td align="left" valign="middle" class="formMain">
					<input type="text"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("NewMatchesSpecialProgramsNonMentoring") %><% Else %>0<% End If %>" name="frmPerformanceNewMatchesSpecialProgramsNonMentoring" tabindex="2" onchange="checkForIntegerCommas(this.value); addUpOpenSpecNonMent()">
					</td>
				<% else %>
					<!-- Prepopulate the Fields -->
					<td align="center" class="formMain" colspan="3"><span class="formSubHead">No Longer Required</span></td>				
...
<%  If (m=6 or m=12) And SBMAgency = 1 And Y <> 2001 Then %>
			...
			<input type="hidden"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("SBMVolunteersInEnrollmentProcess") %><% Else %>0<% End If %>" name="frmPerformanceSBMVolunteersInEnrollmentProcess">
			<input type="hidden"  class="formMain" size="5" maxlength="10" value="<% If say = "edit" Then %><%= GetPerformance("SBMAmountRaisedTowardsMatchPledge") %><% Else %>0<% End If %>" name="frmPerformanceSBMAmountRaisedTowardsMatchPledge">					
<% End If %>
