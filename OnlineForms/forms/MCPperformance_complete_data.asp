...
<% if printform = "No" then %>
	...
	<tr>
		<td colspan="7" class="formHeader">MCP Grant Performance<br><%= MonthName(Request("m"), False) & " " & Request("y") %></td>
	</tr>
			
<% else %>			

	<tr>
		<td colspan="7" class="formIndex">MCP Grant Performance<br><%= MonthName(Request("m"), False) & " " & Request("y") %></td>
	</tr>	
...
<% end if %>
		...
		<tr>
			...
			<td colspan="7" class="formMainBold">Created: <%= GetMCPPerformance("CreateDate") %><br>		
			
			<% form = "MCPPerformance" %> 
			<% gid = GetMCPPerformance("MCPPerformanceID") %>
			<%= GetMCPPerformance("MCPPerformanceID") %>
		...
		<tr>
			...
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("ClosedMatchesCommunityBased") %></td>
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("ClosedMatchesSchoolBased") %></td>
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("ClosedMatchesOtherSiteBased") %></td>
		...
		<% end if %>
			...
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("NewMatchesCommunityBased") %></td>
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("NewMatchesSchoolBased") %></td>
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("NewMatchesSiteBasedNonSchool") %></td>
		</tr>	
		...
		<tr>
			...
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("OpenMatchesCommunityBased") %></td>
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("OpenMatchesSchoolBased") %></td>
			<td align="right" valign="middle" class="formMain"><%= GetMCPPerformance("OpenMatchesOtherSiteBased") %></td>
