...
<style>BODY { FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Verdana, Arial }
	DIV { FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Verdana, Arial }
	TD { FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Verdana, Arial }
	INPUT { FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Verdana, Arial }
	DIV { BORDER-RIGHT: black 1px solid; PADDING-RIGHT: 5px; BORDER-TOP: black 1px solid; DISPLAY: block; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; BORDER-LEFT: black 1px solid; WIDTH: 100%; PADDING-TOP: 5px; BORDER-BOTTOM: black 1px solid; BACKGROUND-COLOR: aliceblue }
	DIV.label { BORDER-RIGHT: white 0px; PADDING-RIGHT: 0px; BORDER-TOP: white 0px; MARGIN-TOP: 8px; PADDING-LEFT: 0px; FONT-WEIGHT: bold; FONT-SIZE: 10pt; MARGIN-BOTTOM: 2px; PADDING-BOTTOM: 0px; MARGIN-LEFT: 10px; BORDER-LEFT: white 0px; PADDING-TOP: 0px; BORDER-BOTTOM: white 0px; FONT-FAMILY: Georgia, Verdana; BACKGROUND-COLOR: white; FONT-VARIANT: small-caps }
	DIV.reg { BORDER-RIGHT: black 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: black 1px solid; DISPLAY: block; PADDING-LEFT: 3px; PADDING-BOTTOM: 3px; BORDER-LEFT: black 1px solid; WIDTH: 95%; PADDING-TOP: 3px; BORDER-BOTTOM: black 1px solid; BACKGROUND-COLOR: gainsboro }
