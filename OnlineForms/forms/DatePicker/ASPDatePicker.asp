			...
			<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
				<tr>
					<td class="arrows" style="text-align: left;" valign="bottom">
						<img SRC="ASPDatePicker/previousmonth.gif" WIDTH="11" HEIGHT="15" border="0" title="Previous Month" onClick="previousMonth();" style="cursor: hand;"><img SRC="ASPDatePicker/previousyear.gif" WIDTH="9" HEIGHT="15" border="0" title="Previous Year" onClick="previousYear();" style="cursor: hand;">
					</td>
					<td class="titleText">
					...
					<td class="arrows" style="text-align: right;" valign="bottom">
						<img SRC="ASPDatePicker/nextyear.gif" WIDTH="9" HEIGHT="15" border="0" title="Next Year" onClick="nextYear();" style="cursor: hand;"><img SRC="ASPDatePicker/nextmonth.gif" WIDTH="11" HEIGHT="15" border="0" title="Next Month" onClick="nextMonth();" style="cursor: hand;">
					</td>
				</tr>
			</table>
		</td>
