	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<form method="post" action="monthly.asp">
				...
				<% if (AimAgency = "n"  or AdminLevel = 1) and (int(Session("AgencyIDN")) <> 240) then %>
				<td align="left" bgcolor="#cccccc" class="formMainBold">
...
<!-- Finance Form -->
			...
			<%
				...
				set Con = Server.CreateObject("ADODB.Connection")
				Con.Open "BBBSAforms", "sa", "12sist12"
				'sql = "p_getFinancePerformanceFormDatesALL '" & Session("AgencyIDN") & "'"  'display all dates - slp
...
'					dim currentYear
			...
			<form method="post" action="monthly.asp">
				...
				<% if int(Session("AgencyIDN")) <> 240 then %>
				<td align="left" bgcolor="#cccccc">				
				<select name="month" size=1 class="formMain">
					<% 	
						if setNextMonth = true then
