...
function addEmUp() 
{
	...
	var box3 = Number(document.frmExpenses.frmExpensesProfessionalFees.value)
	var box4 = Number(document.frmExpenses.frmExpensesRentOccupancy.value)
	var box5 = Number(document.frmExpenses.frmExpensesSupplies.value)
	var box6 = Number(document.frmExpenses.frmExpensesCapFurnEquip.value)
	var box7 = Number(document.frmExpenses.frmExpensesInsurance.value)	
	var box8 = Number(document.frmExpenses.frmExpensesMarketing.value)	
	var box9 = Number(document.frmExpenses.frmExpensesOther.value)
	var boxtotal = box1 + box2 + box3 + box4 + box5 + box6 + box7 + box8 + box9
...
//	}
	...
	else if(!(myRegularExpression1.test(form.frmExpensesProfessionalFees.value)))	
	{
		form.frmExpensesProfessionalFees.focus();
		alert((form.frmExpensesProfessionalFees.value) + " is invalid.");
		return false;
	}
	else if(!(myRegularExpression1.test(form.frmExpensesRentOccupancy.value)))
	{
		form.frmExpensesRentOccupancy.focus();
		alert((form.frmExpensesRentOccupancy.value) + " is invalid.");
		return false;
	}
	else if(!(myRegularExpression1.test(form.frmExpensesSupplies.value)))	
	{
		form.frmExpensesSupplies.focus();
		alert((form.frmExpensesSupplies.value) + " is invalid.");
		return false;
	}
	
	else if(!(myRegularExpression1.test(form.frmExpensesCapFurnEquip.value)))	
	{
		form.frmExpensesCapFurnEquip.focus();
		alert((form.frmExpensesCapFurnEquip.value) + " is invalid.");
		return false;
	}	
	...
	else if(!(myRegularExpression1.test(form.frmExpensesMarketing.value)))	
	{
		form.frmExpensesMarketing.focus();
		alert((form.frmExpensesMarketing.value) + " is invalid.");
		return false;
	}			
...
%>
	...
	<tr>
		<td colspan="6" class="formHeader">EXPENSES</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="formMain" width="24%">Capital, Furniture, Equipment:</td>
		<td class="formMainRightJ" width="24%">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("CapFurnEquip") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesCapFurnEquip" onFocus="addEmUp();" onchange="checkForInteger(this.value);"></td>		
	</tr>
	<tr>
	...
	<tr>
		<td class="formMain" width="24%">Professional Fees:</td>
		<td class="formMainRightJ" width="24%">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("ProfessionalFees") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesProfessionalFees" onFocus="addEmUp();" onchange="checkForInteger(this.value);"></td>
		<td colspan="2" width="4%">&nbsp;</td>		
		<td class="formMain" width="24%">Marketing:</td>						
		<td class="formMainRightJ" width="24%">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("Marketing") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesMarketing" onFocus="addEmUp();" onchange="checkForInteger(this.value);"></td>						
	</tr>
	<tr>
		<td class="formMain" width="24%">Rent and Occupancy:</td>
		<td class="formMainRightJ" width="24%">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("RentOccupancy") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesRentOccupancy" onFocus="addEmUp();" onchange="checkForInteger(this.value);"></td>
		<td colspan="2" width="4%">&nbsp;</td>		
	...
	<tr>
		<td class="formMain" width="24%">Supplies:</td>
		<td class="formMainRightJ" width="24%">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("Supplies") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesSupplies" onFocus="addEmUp();" onchange="checkForInteger(this.value);"></td>
		<td colspan="2" width="4%">&nbsp;</td>		
