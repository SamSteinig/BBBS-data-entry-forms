...
If Request("status") = "addNew" Then
	...
	If(numberOfExisting = 0) Then
		...
		'RST("ProfDuesFullPaid") = Request("frmBenefitsProfDuesFullPaid") //Removal of PAID checkbox
		...
		'RST("ProfDuesPartPaid") = Request("frmBenefitsProfDuesPartPaid") //Removal of PAID checkbox
		...
		RST("ProfDevBudgetFull") = Request("frmBenefitsProfDevBudgetFull")
		If LEN(Request("frmBenefitsProfDevBudgetFullAmount")) = 0 Then
			RST("ProfDevBudgetFullAmount") = NULL
		Else
			RST("ProfDevBudgetFullAmount") = Int(Request("frmBenefitsProfDevBudgetFullAmount"))
		End If
		
		RST("ProfDevBudgetPart") = Request("frmBenefitsProfDevBudgetPart")
		If LEN(Request("frmBenefitsProfDevBudgetPartAmount")) = 0 Then
			RST("ProfDevBudgetPartAmount") = NULL
		Else
			RST("ProfDevBudgetPartAmount") = Int(Request("frmBenefitsProfDevBudgetPartAmount"))
...
ElseIf Request("status") = "editSave" Then
	...
	RST.Open "SELECT * FROM tbl_frmBenefits WHERE AgencyID = '" & Request("AgencyIDN") & "' AND Year=" & Int(Request("year")), Con, 1, 3
		...
		RST("DisInsShortTermFull") = Request("frmBenefitsDisInsShortTermFull")
		'RST("DisInsShortTermFullPaid") = Request("frmBenefitsDisInsShortTermFullPaid") //Removal of PAID checkbox
		RST("DisInsShortTermFullPrcnt") = Int(Request("frmBenefitsDisInsShortTermFullPrcnt"))
		RST("DisInsShortTermFullAmount") = Int(Request("frmBenefitsDisInsShortTermFullAmount"))
		RST("DisInsShortTermPart") = Request("frmBenefitsDisInsShortTermPart")
		'RST("DisInsShortTermPartPaid") = Request("frmBenefitsDisInsShortTermPartPaid") //Removal of PAID checkbox
		RST("DisInsShortTermPartPrcnt") = Int(Request("frmBenefitsDisInsShortTermPartPrcnt"))
		RST("DisInsShortTermPartAmount") = Int(Request("frmBenefitsDisInsShortTermPartAmount"))
		
		RST("DisInsLongTermFull") = Request("frmBenefitsDisInsLongTermFull")
		'RST("DisInsLongTermFullPaid") = Request("frmBenefitsDisInsLongTermFullPaid") //Removal of PAID checkbox
		RST("DisInsLongTermFullPrcnt") = Int(Request("frmBenefitsDisInsLongTermFullPrcnt"))
		RST("DisInsLongTermFullAmount") = Int(Request("frmBenefitsDisInsLongTermFullAmount"))
		RST("DisInsLongTermPart") = Request("frmBenefitsDisInsLongTermPart")
		'RST("DisInsLongTermPartPaid") = Request("frmBenefitsDisInsLongTermPartPaid") //Removal of PAID checkbox
		RST("DisInsLongTermPartPrcnt") = Int(Request("frmBenefitsDisInsLongTermPartPrcnt"))
		RST("DisInsLongTermPartAmount") = Int(Request("frmBenefitsDisInsLongTermPartAmount"))
		
		RST("EAPFull") = Request("frmBenefitsEAPFull")
		'RST("EAPFullPaid") = Request("frmBenefitsEAPFullPaid") //Removal of PAID checkbox
		RST("EAPFullPrcnt") = Int(Request("frmBenefitsEAPFullPrcnt"))
		RST("EAPFullAmount") = Int(Request("frmBenefitsEAPFullAmount"))
		RST("EAPPart") = Request("frmBenefitsEAPPart")
		'RST("EAPPartPaid") = Request("frmBenefitsEAPPartPaid") //Removal of PAID checkbox
		RST("EAPPartPrcnt") = Int(Request("frmBenefitsEAPPartPrcnt"))
		RST("EAPPartAmount") = Int(Request("frmBenefitsEAPPartAmount"))
		...
		RST("HealthClubFull") = Request("frmBenefitsHealthClubFull")
		'RST("HealthClubFullPaid") = Request("frmBenefitsHealthClubFullPaid") //Removal of PAID checkbox
		RST("HealthClubFullPrcnt") = Int(Request("frmBenefitsHealthClubFullPrcnt"))
		RST("HealthClubFullAmount") = Int(Request("frmBenefitsHealthClubFullAmount"))
		RST("HealthClubPart") = Request("frmBenefitsHealthClubPart")
		'RST("HealthClubPartPaid") = Request("frmBenefitsHealthClubPartPaid") //Removal of PAID checkbox
		RST("HealthClubPartPrcnt") = Int(Request("frmBenefitsHealthClubPartPrcnt"))
		RST("HealthClubPartAmount") = Int(Request("frmBenefitsHealthClubPartAmount"))
		...
		RST("ProfDevBudgetFullAmount") = Int(Request("frmBenefitsProfDevBudgetFullAmount"))
		RST("ProfDevBudgetPart") = Request("frmBenefitsProfDevBudgetPart")
		'RST("ProfDevBudgetPartPaid") = Request("frmBenefitsProfDevBudgetPartPaid")
		RST("ProfDevBudgetPartAmount") = Int(Request("frmBenefitsProfDevBudgetPartAmount"))
...
function submitFormValidate(form)
{
	...
	else if(form.frmBenefitsDisInsShortTermFull.value == "selected")	
	{
		form.frmBenefitsDisInsShortTermFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsDisInsShortTermPart.value == "selected")	
	{
		form.frmBenefitsDisInsShortTermPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsDisInsLongTermFull.value == "selected")	
	{
		form.frmBenefitsDisInsLongTermFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsDisInsLongTermPart.value == "selected")	
	{
		form.frmBenefitsDisInsLongTermPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsEAPFull.value == "selected")	
	{
		form.frmBenefitsEAPFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsEAPPart.value == "selected")	
	{
		form.frmBenefitsEAPPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsHealthClubFull.value == "selected")	
	{
		form.frmBenefitsHealthClubFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsHealthClubPart.value == "selected")	
	{
		form.frmBenefitsHealthClubPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsLifeInsuranceFull.value == "selected")	
	{
		form.frmBenefitsLifeInsuranceFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsLifeInsurancePart.value == "selected")	
	{
		form.frmBenefitsLifeInsurancePart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTimeOffFull.value == "selected")	
	{
		form.frmBenefitsTimeOffFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTimeOffFullNExempt.value == "selected")	
	{
		form.frmBenefitsTimeOffFullNExempt.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTimeOffPart.value == "selected")	
	{
		form.frmBenefitsTimeOffPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTimeOffPartNExempt.value == "selected")	
	{
		form.frmBenefitsTimeOffPartNExempt.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTimeOffSickFull.value == "selected")	
	{
		form.frmBenefitsTimeOffSickFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTimeOffSickPart.value == "selected")	
	{
		form.frmBenefitsTimeOffSickPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsProfDuesFull.value == "selected")	
	{
		form.frmBenefitsProfDuesFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsProfDuesPart.value == "selected")	
	{
		form.frmBenefitsProfDuesPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsRetirementFull.value == "selected")	
	{
		form.frmBenefitsRetirementFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsRetirementPart.value == "selected")	
	{
		form.frmBenefitsRetirementPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefits403BFull.value == "selected")	
	{
		form.frmBenefits403BFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefits403BPart.value == "selected")	
	{
		form.frmBenefits403BPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTelecommFull.value == "selected")	
	{
		form.frmBenefitsTelecommFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTelecommPart.value == "selected")	
	{
		form.frmBenefitsTelecommPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTuitionFull.value == "selected")	
	{
		form.frmBenefitsTuitionFull.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
	else if(form.frmBenefitsTuitionPart.value == "selected")	
	{
		form.frmBenefitsTuitionPart.focus();
		alert("Please select whether your agency offer this benefit.");
		return false;
	}
...
/* Commented on 10/17/2007 due to request for allowing unknown amounts for vision if it is part of medical plan.
	...
	{
		alert("You selected that you offer Vision Benefits, but did not entered hi Percentages and Amounts. Please enter required data or select that you do NOT offer Vision Benefits");
...
*/
	...
	//TIME OFF
	else if ((form.frmBenefitsTimeOffFull.value == 'true') && ((form.frmBenefitsTimeOffFullDays.value == 0)&&(form.frmBenefitsTimeOffFullYears.value == 0)&&(form.frmBenefitsTimeOffFullDaysIncreased.value == 0)))
	{
	...
	//
	else if ((form.frmBenefitsTimeOffFullNExempt.value == 'true') && ((form.frmBenefitsTimeOffFullDaysNExempt.value == 0)&&(form.frmBenefitsTimeOffFullYearsNExempt.value == 0)&&(form.frmBenefitsTimeOffFullDaysIncreasedNExempt.value == 0)))
	{
		alert("You selected that you offer Paid Time Off, but did not enter the number of paid days or years or days after increase. Please enter required data or select that you DO NOT offer Paid Time Off");
	...
	//
	else if ((form.frmBenefitsTimeOffPart.value == 'true') && ((form.frmBenefitsTimeOffPartDays.value == 0)&&(form.frmBenefitsTimeOffPartYears.value == 0)&&(form.frmBenefitsTimeOffPartDaysIncreased.value == 0)))
	{
	...
	//
	else if ((form.frmBenefitsTimeOffPartNExempt.value == 'true') && ((form.frmBenefitsTimeOffPartDaysNExempt.value == 0)&&(form.frmBenefitsTimeOffPartYearsNExempt.value == 0)&&(form.frmBenefitsTimeOffPartDaysIncreasedNExempt.value == 0)))
	{
		alert("You selected that you offer Paid Time Off, but did not enter the number of paid days or years or days after increase. Please enter required data or select that you do NOT offer Paid Time Off");
	...
	//TIME SICK
	else if ((form.frmBenefitsTimeOffSickFull.value == 'true') && (form.frmBenefitsTimeOffSickFullDays.value == 0))
	{
	...
	else if ((form.frmBenefitsTimeOffSickPart.value == 'true') && (form.frmBenefitsTimeOffSickPartDays.value == 0))
	{
		alert("You selected that you offer Paid Sick Time, but did not enter the number of paid sick days. Please enter required data or select that you DO NOT offer Paid Sick Time");
	...
	//PENSION PLAN
	else if ((form.frmBenefitsRetirementFull.value == 'true') && (form.frmBenefitsRetirementFullPrcnt.value == 0))
	{
		alert("You selected that you offer Pension Plan, but did not enter the Percent of Agency Contribution. Please enter required data or select that you DO NOT offer Pension Plan");
		form.frmBenefitsRetirementFullPrcnt.focus();
		return false;
	}
	else if ((form.frmBenefitsRetirementPart.value == 'true') && (form.frmBenefitsRetirementPartPrcnt.value == 0))
	{
		alert("You selected that you offer Pension Plan, but did not enter the Percent of Agency Contribution. Please enter required data or select that you DO NOT offer Pension Plan");
	...
	{
		alert("You selected that your agency contributes to Employee 403B, but did not enter the Percent of Matching Contribution. Please enter required data or select that you DO NOT match Employee contribution");
	...
	{
		form.frmBenefits403BFullContribPrcnt.focus();
		alert("Please enter percent of matching contribution for 403B.");
		return false;
	}
	...
	{
		alert("Both Number of Employees and Percent of Employee Population must be greater than 0 or equal 0. Please enter missing information.");
	...
	//TUITION
	else if ((form.frmBenefitsTuitionFull.value == 'true') && (form.frmBenefitsTuitionFullAmount.value == 0))
	{
	...
	else if ((form.frmBenefitsTuitionPart.value == 'true') && (form.frmBenefitsTuitionPartAmount.value == 0))
	{
		alert("You selected that you offer Tuition Reimbursement, but did not enter the maximum Amount. Please enter required data or select that you DO NOT offer Tuition Reimbursement");
	...
	//Tuition
	else if((form.frmBenefitsTuitionFull.value == "true") && (Number(form.frmBenefitsTuitionFullAmount.value) == 0))
	{
		form.frmBenefitsTuitionFullAmount.focus();
		alert("You selected that you offer tuition reimbersement but left 0 for the maximum amount. Please enter the maximum amount.");
		return false;
	}
	else if((form.frmBenefitsTuitionPart.value == "true") && (Number(form.frmBenefitsTuitionPartAmount.value) == 0))
	{
		form.frmBenefitsTuitionPartAmount.focus();
		alert("You selected that you offer tuition reimbersement but left 0 for the maximum amount. Please enter the maximum amount.");
		return false;
	...
	else
	{
	  var validation_value
		//medical
		if ((form.frmBenefitsBenMedOffered.value == "true") && (form.frmBenefitsBenMedFullEmployee.value == 0) && (form.frmBenefitsBenMedFullEmployeeAmount.value == 0) && (form.frmBenefitsBenMedFullFamily.value == 0) && (form.frmBenefitsBenMedFullFamilyAmount.value == 0) && (form.frmBenefitsBenMedPartEmployee.value == 0) && (form.frmBenefitsBenMedPartEmployeeAmount.value == 0) && (form.frmBenefitsBenMedPartFamily.value == 0) && (form.frmBenefitsBenMedPartFamilyAmount.value == 0))
		{
			form.frmBenefitsBenMedFullEmployee.focus();
			validation_value = confirm("You selected that you offer Medical Benefits, but did not enter Percentages and Amounts. Please enter required data or select that you DO NOT offer Medical Benefits");
		...
		if((form.frmBenefitsBenMedOffered.value == "true") && (Number(form.frmBenefitsBenMedFullEmployeeAmount.value) != 0) && (Number(form.frmBenefitsBenMedFullEmployeeAmount.value)<300 || Number(form.frmBenefitsBenMedFullEmployeeAmount.value)>2000))
		{
		form.frmBenefitsBenMedFullEmployeeAmount.focus();
		validation_value = confirm("Employee medical monthly premium ( $" + form.frmBenefitsBenMedFullEmployeeAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		if((form.frmBenefitsBenMedOffered.value == "true") && (Number(form.frmBenefitsBenMedPartEmployeeAmount.value) != 0) && (Number(form.frmBenefitsBenMedPartEmployeeAmount.value)<300 || Number(form.frmBenefitsBenMedPartEmployeeAmount.value)>2000))
		{
		form.frmBenefitsBenMedPartEmployeeAmount.focus();
		validation_value = confirm("Employee medical monthly premium ( $" + form.frmBenefitsBenMedPartEmployeeAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
	   ...
	   if((form.frmBenefitsBenMedOffered.value == "true") && (Number(form.frmBenefitsBenMedFullFamilyAmount.value) != 0) && (Number(form.frmBenefitsBenMedFullFamilyAmount.value)<300 || Number(form.frmBenefitsBenMedFullFamilyAmount.value)>2000))
		{
		form.frmBenefitsBenMedFullFamilyAmount.focus();
		validation_value =  confirm("Family medical monthly premium ( $" + form.frmBenefitsBenMedFullFamilyAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
	   if((form.frmBenefitsBenMedOffered.value == "true") && (Number(form.frmBenefitsBenMedPartFamilyAmount.value) != 0) && (Number(form.frmBenefitsBenMedPartFamilyAmount.value)<300 || Number(form.frmBenefitsBenMedPartFamilyAmount.value)>2000))
		{
		form.frmBenefitsBenMedPartFamilyAmount.focus();
		validation_value =  confirm("Family medical monthly premium ( $" + form.frmBenefitsBenMedPartFamilyAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//dental
		if ((form.frmBenefitsBenDentOffered.value == "true") && (form.frmBenefitsBenDentFullEmployee.value == 0) && (form.frmBenefitsBenDentFullEmployeeAmount.value == 0) && (form.frmBenefitsBenDentFullFamily.value == 0) && (form.frmBenefitsBenDentFullFamilyAmount.value == 0) && (form.frmBenefitsBenDentPartEmployee.value == 0) && (form.frmBenefitsBenDentPartEmployeeAmount.value == 0) && (form.frmBenefitsBenDentPartFamily.value == 0) && (form.frmBenefitsBenDentPartFamilyAmount.value == 0))
		{
			form.frmBenefitsBenDentFullEmployee.focus();
			validation_value = confirm("You selected that you offer Dental Benefits, but did not enter Percentages and Amounts. Please enter required data or select that you DO NOT offer Dental Benefits");
			if (validation_value == false)
			{
				return false;
			}
		}
	   if((form.frmBenefitsBenDentOffered.value == "true") && (Number(form.frmBenefitsBenDentFullEmployeeAmount.value) != 0) && (Number(form.frmBenefitsBenDentFullEmployeeAmount.value)<0 || Number(form.frmBenefitsBenDentFullEmployeeAmount.value)>80))
		{
		form.frmBenefitsBenDentFullEmployeeAmount.focus();
		validation_value = confirm("Employee dental monthly premium ( $" + form.frmBenefitsBenDentFullEmployeeAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
	   if((form.frmBenefitsBenDentOffered.value == "true") && (Number(form.frmBenefitsBenDentPartEmployeeAmount.value) != 0) && (Number(form.frmBenefitsBenDentPartEmployeeAmount.value)<0 || Number(form.frmBenefitsBenDentPartEmployeeAmount.value)>80))
		{
		form.frmBenefitsBenDentPartEmployeeAmount.focus();
		validation_value = confirm("Employee dental monthly premium ( $" + form.frmBenefitsBenDentPartEmployeeAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsBenDentOffered.value == "true") && (Number(form.frmBenefitsBenDentFullFamilyAmount.value) != 0) && (Number(form.frmBenefitsBenDentFullFamilyAmount.value)<0 || Number(form.frmBenefitsBenDentFullFamilyAmount.value)>80))
		{
		form.frmBenefitsBenDentFullFamilyAmount.focus();
		validation_value = confirm("Family dental monthly premium ( $" + form.frmBenefitsBenDentFullFamilyAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsBenDentOffered.value == "true") && (Number(form.frmBenefitsBenDentPartFamilyAmount.value) != 0) && (Number(form.frmBenefitsBenDentPartFamilyAmount.value)<0 || Number(form.frmBenefitsBenDentPartFamilyAmount.value)>80))
		{
		form.frmBenefitsBenDentPartFamilyAmount.focus();
		validation_value = confirm("Family dental monthly premium ( $" + form.frmBenefitsBenDentPartFamilyAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//vision
		if ((form.frmBenefitsBenVisOffered.value == "true") && (form.frmBenefitsBenVisFullEmployee.value == 0) && (form.frmBenefitsBenVisFullEmployeeAmount.value == 0) && (form.frmBenefitsBenVisFullFamily.value == 0) && (form.frmBenefitsBenVisFullFamilyAmount.value == 0) && (form.frmBenefitsBenVisPartEmployee.value == 0) && (form.frmBenefitsBenVisPartEmployeeAmount.value == 0) && (form.frmBenefitsBenVisPartFamily.value == 0) && (form.frmBenefitsBenVisPartFamilyAmount.value == 0))
		{
			form.frmBenefitsBenVisFullEmployee.focus();
			validation_value = confirm("You selected that you offer Vision Benefits, but did not enter Percentages and Amounts. Please enter required data or select that you DO NOT offer Vision Benefits");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsBenVisOffered.value == "true") && (Number(form.frmBenefitsBenVisFullEmployeeAmount.value) != 0) && (Number(form.frmBenefitsBenVisFullEmployeeAmount.value)<0 || Number(form.frmBenefitsBenVisFullEmployeeAmount.value)>75))
		{
		form.frmBenefitsBenVisFullEmployeeAmount.focus();
		validation_value = confirm("Employee vision monthly premium ( $" + form.frmBenefitsBenVisFullEmployeeAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsBenVisOffered.value == "true") && (Number(form.frmBenefitsBenVisPartEmployeeAmount.value) != 0) && (Number(form.frmBenefitsBenVisPartEmployeeAmount.value)<0 || Number(form.frmBenefitsBenVisPartEmployeeAmount.value)>75))
		{
		form.frmBenefitsBenVisPartEmployeeAmount.focus();
		validation_value = confirm("Employee vision monthly premium ( $" + form.frmBenefitsBenVisPartEmployeeAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsBenVisOffered.value == "true") && (Number(form.frmBenefitsBenVisFullFamilyAmount.value) != 0) && (Number(form.frmBenefitsBenVisFullFamilyAmount.value)<0 || Number(form.frmBenefitsBenVisFullFamilyAmount.value)>75))
		{
		form.frmBenefitsBenVisFullFamilyAmount.focus();
		validation_value = confirm("Family vision monthly premium ( $" + form.frmBenefitsBenVisFullFamilyAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsBenVisOffered.value == "true") && (Number(form.frmBenefitsBenVisPartFamilyAmount.value) != 0) && (Number(form.frmBenefitsBenVisPartFamilyAmount.value)<0 || Number(form.frmBenefitsBenVisPartFamilyAmount.value)>75))
		{
		form.frmBenefitsBenVisPartFamilyAmount.focus();
		validation_value = confirm("Family vision monthly premium ( $" + form.frmBenefitsBenVisPartFamilyAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//short term
		if((form.frmBenefitsDisInsShortTermFull.value == "true") && (Number(form.frmBenefitsDisInsShortTermFullAmount.value)<10 || Number(form.frmBenefitsDisInsShortTermFullAmount.value)>150))
		{
		form.frmBenefitsDisInsShortTermFullAmount.focus();
		validation_value = confirm("The short term disability monthly premium ( $" + form.frmBenefitsDisInsShortTermFullAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsDisInsShortTermPart.value == "true") && (Number(form.frmBenefitsDisInsShortTermPartAmount.value)<10 || Number(form.frmBenefitsDisInsShortTermPartAmount.value)>150))
		{
		form.frmBenefitsDisInsShortTermPartAmount.focus();
		validation_value = confirm("The short term disability monthly premium ( $" + form.frmBenefitsDisInsShortTermPartAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		/*if((form.frmBenefitsDisInsShortTermFull.checked == true) && (Number(form.frmBenefitsDisInsShortTermFullAmount.value)<10 || Number(form.frmBenefitsDisInsShortTermFullAmount.value)>50))
		{
		form.frmBenefitsDisInsShortTermFullAmount.focus();
		validation_value = confirm("The short term disability monthly premium ( $" + form.frmBenefitsDisInsShortTermFullAmount.value + " ) you entered is outside of normal range. Click OK to continue or CANCEL to re enter the premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//long term
		if((form.frmBenefitsDisInsLongTermFull.value == "true") && (Number(form.frmBenefitsDisInsLongTermFullAmount.value)<10 || Number(form.frmBenefitsDisInsLongTermFullAmount.value)>50))
		{
		form.frmBenefitsDisInsLongTermFullAmount.focus();
		validation_value = confirm("The long term disability monthly premium ( $" + form.frmBenefitsDisInsLongTermFullAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsDisInsLongTermPart.value == "true") && (Number(form.frmBenefitsDisInsLongTermPartAmount.value)<10 || Number(form.frmBenefitsDisInsLongTermPartAmount.value)>50))
		{
		form.frmBenefitsDisInsLongTermPartAmount.focus();
		validation_value = confirm("The long term disability monthly premium ( $" + form.frmBenefitsDisInsLongTermPartAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//EPA
		if((form.frmBenefitsEAPFull.value == "true") && (Number(form.frmBenefitsEAPFullAmount.value)<5 || Number(form.frmBenefitsEAPFullAmount.value)>35))
		{
		form.frmBenefitsEAPFullAmount.focus();
		validation_value = confirm("The EPA monthly premium ( $" + form.frmBenefitsEAPFullAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsEAPPart.value == "true") && (Number(form.frmBenefitsEAPPartAmount.value)<5 || Number(form.frmBenefitsEAPPartAmount.value)>35))
		{
		form.frmBenefitsEAPPartAmount.focus();
		validation_value = confirm("The EPA monthly premium ( $" + form.frmBenefitsEAPPartAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//Health Club
		if((form.frmBenefitsHealthClubFull.value == "true") && (Number(form.frmBenefitsHealthClubFullAmount.value)<20 || Number(form.frmBenefitsHealthClubFullAmount.value)>60))
		{
		form.frmBenefitsHealthClubFullAmount.focus();
		validation_value = confirm("The Health club monthly premium ( $" + form.frmBenefitsHealthClubFullAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsHealthClubPart.value == "true") && (Number(form.frmBenefitsHealthClubPartAmount.value)<20 || Number(form.frmBenefitsHealthClubPartAmount.value)>60))
		{
		form.frmBenefitsHealthClubPartAmount.focus();
		validation_value = confirm("The Health club monthly premium ( $" + form.frmBenefitsHealthClubPartAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//Life Insurance
		if((form.frmBenefitsLifeInsuranceFull.value == "true") && (Number(form.frmBenefitsLifeInsuranceFullAmount.value)<15 || Number(form.frmBenefitsLifeInsuranceFullAmount.value)>75))
		{
		form.frmBenefitsLifeInsuranceFullAmount.focus();
		validation_value = confirm("The Life insurance monthly premium ( $" + form.frmBenefitsLifeInsuranceFullAmount.value + " ) you entered is outside of normal range.If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsLifeInsurancePart.value == "true") && (Number(form.frmBenefitsLifeInsurancePartAmount.value)<15 || Number(form.frmBenefitsLifeInsurancePartAmount.value)>75))
		{
		form.frmBenefitsLifeInsurancePartAmount.focus();
		validation_value = confirm("The Life insurance monthly premium ( $" + form.frmBenefitsLifeInsurancePartAmount.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter premium amount.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//Time off
		if((form.frmBenefitsTimeOffFull.value == "true") && (Number(form.frmBenefitsTimeOffFullDaysIncreased.value)<5 || Number(form.frmBenefitsTimeOffFullDaysIncreased.value)>25))
		{
		form.frmBenefitsTimeOffFullDaysIncreased.focus();
		validation_value = confirm("The total number of days after increase ( " + form.frmBenefitsTimeOffFullDaysIncreased.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter vacation days.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsTimeOffPart.value == "true") && (Number(form.frmBenefitsTimeOffPartDaysIncreased.value)<5 || Number(form.frmBenefitsTimeOffPartDaysIncreased.value)>25))
		{
		form.frmBenefitsTimeOffPartDaysIncreased.focus();
		validation_value = confirm("The total number of days after increase ( " + form.frmBenefitsTimeOffPartDaysIncreased.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter vacation days.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsTimeOffFullNExempt.value == "true") && (Number(form.frmBenefitsTimeOffFullDaysIncreasedNExempt.value)<5 || Number(form.frmBenefitsTimeOffFullDaysIncreasedNExempt.value)>25))
		{
		form.frmBenefitsTimeOffFullDaysIncreasedNExempt.focus();
		validation_value = confirm("The total number of days after increase ( " + form.frmBenefitsTimeOffFullDaysIncreasedNExempt.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter vacation days.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsTimeOffPartNExempt.value == "true") && (Number(form.frmBenefitsTimeOffPartDaysIncreasedNExempt.value)<5 || Number(form.frmBenefitsTimeOffPartDaysIncreasedNExempt.value)>25))
		{
		form.frmBenefitsTimeOffPartDaysIncreasedNExempt.focus();
		validation_value = confirm("The total number of days after increase ( " + form.frmBenefitsTimeOffPartDaysIncreasedNExempt.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter vacation days.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//Time Sick
		if((form.frmBenefitsTimeOffSickFull.value == "true") && (Number(form.frmBenefitsTimeOffSickFullDays.value)<5 || Number(form.frmBenefitsTimeOffSickFullDays.value)>15))
		{
		form.frmBenefitsTimeOffSickFullDays.focus();
		validation_value = confirm("The total number of sick days ( " + form.frmBenefitsTimeOffSickFullDays.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter sick days.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsTimeOffSickPart.value == "true") && (Number(form.frmBenefitsTimeOffSickPartDays.value)<1 || Number(form.frmBenefitsTimeOffSickPartDays.value)>15))
		{
		form.frmBenefitsTimeOffSickPartDays.focus();
		validation_value = confirm("The total number of sick days ( " + form.frmBenefitsTimeOffSickPartDays.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter sick days.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//Retirement
		if((form.frmBenefitsRetirementFull.value == "true") && (Number(form.frmBenefitsRetirementFullPrcnt.value)<1 || Number(form.frmBenefitsRetirementFullPrcnt.value)>7))
		{
		form.frmBenefitsRetirementFullPrcnt.focus();
		validation_value = confirm("The contribution by agency ( " + form.frmBenefitsRetirementFullPrcnt.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter Percent.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefitsRetirementPart.value == "true") && (Number(form.frmBenefitsRetirementPartPrcnt.value)<1 || Number(form.frmBenefitsRetirementPartPrcnt.value)>7))
		{
		form.frmBenefitsRetirementPartPrcnt.focus();
		validation_value = confirm("The contribution ( " + form.frmBenefitsRetirementPartPrcnt.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter Percent.");
			if (validation_value == false)
			{
				return false;
			}
		...
		//403B
		if((form.frmBenefits403BFull.value == "true") && (Number(form.frmBenefits403BFullContribPrcnt.value)<1 || Number(form.frmBenefits403BFullContribPrcnt.value)>7))
		{
		form.frmBenefits403BFullContribPrcnt.focus();
		validation_value = confirm("The contribution by agency ( " + form.frmBenefits403BFullContribPrcnt.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter Percent.");
			if (validation_value == false)
			{
				return false;
			}
		}
		if((form.frmBenefits403BPart.value == "true") && (Number(form.frmBenefits403BPartContribPrcnt.value)<1 || Number(form.frmBenefits403BPartContribPrcnt.value)>7))
		{
		form.frmBenefits403BPartContribPrcnt.focus();
		validation_value = confirm("The contribution ( " + form.frmBenefits403BPartContribPrcnt.value + " ) you entered is outside of normal range. If this number is correct click OK, if not click CANCEL to re enter Percent.");
			if (validation_value == false)
			{
				return false;
			}
		...
		/*else if((form.frmBenefitsDisInsLongTermFull.checked == true) && (Number(form.frmBenefitsDisInsLongTermFullAmount.value)<10 || Number(form.frmBenefitsDisInsLongTermFullAmount.value)>50))
		{
		form.frmBenefitsDisInsLongTermFullAmount.focus();
		validation_value = confirm("The long term disability monthly premium ( $" + form.frmBenefitsDisInsLongTermFullAmount.value + " ) you entered is outside of normal range. Click OK to continue or CANCEL to re enter the premium amount.");
			if (validation_value == false)
			{
				return false;
			}
...
function ZeroIfNotChecked(form)
{
	...
	if (form.frmBenefitsDisInsShortTermFull.value == 'true')
	{
	...
	if (form.frmBenefitsDisInsShortTermPart.value == 'true')
	{
	...
	if (form.frmBenefitsDisInsLongTermFull.value == 'true')
	{
	...
	if (form.frmBenefitsDisInsLongTermPart.value == 'true')
	{
	...
	if (form.frmBenefitsEAPFull.value == 'true')
	{
	...
	if (form.frmBenefitsEAPPart.value == 'true')
	{
	...
	if (form.frmBenefitsHealthClubFull.value == 'true')
	{
	...
	if (form.frmBenefitsHealthClubPart.value == 'true')
	{
	...
	//Life Insurance
	//if (form.frmBenefitsLifeInsuranceFullPaid.checked == true) //removal of PAID check box
	//if (form.frmBenefitsLifeInsuranceFull.checked == true)
	if (form.frmBenefitsLifeInsuranceFull.value == 'true')
	{
	...
	//if (form.frmBenefitsLifeInsurancePartPaid.checked == true) //removal of PAID check box
	//if (form.frmBenefitsLifeInsurancePart.checked == true)
	if (form.frmBenefitsLifeInsurancePart.value == 'true')
	{
	...
	//Sick Time
	if (form.frmBenefitsTimeOffSickFull.value == 'true')
	{
	...
	//if (form.frmBenefitsProfDuesPartPaid.checked == true) //removal of PAID check box
	if (form.frmBenefitsTimeOffSickPart.value == 'true')
	{
	...
	//Prof Dues
	//if (form.frmBenefitsProfDuesFullPaid.checked == true) //removal of PAID check box
	//if (form.frmBenefitsProfDuesFull.checked == true)
	if (form.frmBenefitsProfDuesFull.value == 'true')
	{
	...
	if (form.frmBenefitsProfDuesPart.value == 'true')
	{
...
function CheckForOffer(form)
{
	...
	if (form.frmBenefitsTimeOffFull.value == 'true')
	{
	...
	if (form.frmBenefitsTimeOffFullNExempt.value == 'true')
	{
	...
	if (form.frmBenefitsTimeOffPart.value == 'true')
	{
	...
	if (form.frmBenefitsTimeOffPartNExempt.value == 'true')
	{
	...
	if (form.frmBenefitsRetirementFull.value == 'true')
	{
	...
	if (form.frmBenefitsRetirementPart.value == 'true')
	{
	...
	if (form.frmBenefits403BFull.value == 'true')
	{
	...
	if (form.frmBenefits403BPart.value == 'true')
	{
	...
	if (form.frmBenefitsTelecommFull.value == 'true')
	{
	...
	if (form.frmBenefitsTelecommPart.value == 'true')
	{
	...
	if (form.frmBenefitsTuitionFull.value == 'true')
	{
	...
	if (form.frmBenefitsTuitionPart.value == 'true')
	{
...
addEvent(window, 'load', function()
{
 ...
 if(document.getElementById('frmBenefitsDisInsShortTermFull').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsDisInsShortTermPartPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsDisInsShortTermPart').value == 'false'){
...
//Long Term
 /*if (document.getElementById('frmBenefitsDisInsLongTermFullPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsDisInsLongTermFull').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsDisInsLongTermPartPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsDisInsLongTermPart').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsEAPFullPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsEAPFull').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsEAPPartPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsEAPPart').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsHealthClubFullPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsHealthClubFull').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsHealthClubPartPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsHealthClubPart').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsLifeInsuranceFullPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsLifeInsuranceFull').value == 'false'){
 ...
 /*if (document.getElementById('frmBenefitsLifeInsurancePartPaid').checked == false){
  ...
  if(document.getElementById('frmBenefitsLifeInsurancePart').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTimeOffFull').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTimeOffFullNExempt').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTimeOffPart').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTimeOffPartNExempt').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTimeOffSickFull').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTimeOffSickPart').value == 'false'){
 ...
 if(document.getElementById('frmBenefitsProfDuesFull').value == 'false'){
 ...
 if(document.getElementById('frmBenefitsProfDuesPart').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsRetirementFull').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsRetirementPart').value == 'false'){
 ...
 if(document.getElementById('frmBenefits403BFull').value == 'false'){
 ...
 if(document.getElementById('frmBenefits403BPart').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTelecommFull').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTelecommPart').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTuitionFull').value == 'false'){
 ...
 if (document.getElementById('frmBenefitsTuitionPart').value == 'false'){
...
%>
	...
	<tr>
		<td colspan="6" class="formMain"><font color="#ff0000"><div align="center"><strong>Please Note: After entering your information, you <strong>must</strong> click on the "Save Form" button at the bottom of the form and wait for the "Thank You" screen or your changes will be lost.</div></font></td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<td colspan="6">
			...
			<tr>
				...
				<td class="formHeaderSmall" align="center" colspan="2">Full Time</td>
				<td class="formHeaderSmall" align="center" colspan="2">Part Time (<35 Hours Per Week)</td>				
			</tr>
			...
			<tr>
				<td class="formMain" align="center" cellpadding="1">
					...
					<tr><td>&nbsp;</td></tr>
					<tr><td class="formMain" align=center>Offered</td></tr>
					<tr>
				...
				<td>
					...
					<tr>
						...
						<td class="formMain" valign="top" align="left">What is the Average monthly premium paid for by the agency<br>(Agency + Employee contribution)</td>
					</tr>
					<tr>
						...
						<td class="formMain" valign="top" align="left">What is the Average % Premium is paid for by the agency versus the employee</td>
					</tr>
			...
			<tr>
				...
				<td class="formMain" width="30%">
					...
					<tr>
						...
						<td class="formMain" valign="bottom" align="center">Total<br>Mthly<br>Prem</td>
						<td class="formMain" valign="bottom" align="center">% of<br>Prem<br>Paid by<br>Ag</td>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=DisInsShortTermFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Disability Insurance SHORT Term Per Employee</td>
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table20">
					<tr>
						<td>&nbsp;<select name="frmBenefitsDisInsShortTermFull" size=1 class="formMain" ID="Select6" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("DisInsShortTermFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td>&nbsp;<select name="frmBenefitsDisInsShortTermPart" size=1 class="formMain" ID="Select7" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("DisInsShortTermPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=DisInsLongTermFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Disability Insurance LONG Term Per Employee</td>				
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table22">
					<tr>
						<td>&nbsp;<select name="frmBenefitsDisInsLongTermFull" size=1 class="formMain" ID="Select8" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("DisInsLongTermFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td>&nbsp;<select name="frmBenefitsDisInsLongTermPart" size=1 class="formMain" ID="Select9" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("DisInsLongTermPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=EAPFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;EAP: Employee Assistance Program Per Employee</td>
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table24">
					<tr>
						<td>&nbsp;<select name="frmBenefitsEAPFull" size=1 class="formMain" ID="Select10" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("EAPFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td>&nbsp;<select name="frmBenefitsEAPPart" size=1 class="formMain" ID="Select11" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("EAPPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=HealthClubFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Health Club Per Employee</td>
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table28">
					<tr>
						<td>&nbsp;<select name="frmBenefitsHealthClubFull" size=1 class="formMain" ID="Select12" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("HealthClubFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td>&nbsp;<select name="frmBenefitsHealthClubPart" size=1 class="formMain" ID="Select13" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("HealthClubPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=LifeInsuranceFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Average Life Insurance Premium Per Employee</td>
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table30">
					<tr>
						<td>&nbsp;<select name="frmBenefitsLifeInsuranceFull" size=1 class="formMain" ID="Select14" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("LifeInsuranceFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td>&nbsp;<select name="frmBenefitsLifeInsurancePart" size=1 class="formMain" ID="Select15" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("LifeInsurancePart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table26">
					<tr>
						<td class=formMain width="50%" rowspan=2" valign="top"><a href="../helpfiles/surveyhelp.asp?HelpID=TimeOffFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Paid Time Off Per Year(Vacation, Floating Holidays, Personal Days)</td>
				...
				<td class="formMain" align="center" width="30%">
					...
					<tr>
						<td class=formMain align=center valign=bottom>&nbsp;Offered<br><select name="frmBenefitsTimeOffFull" size=1 class="formMain" ID="Select16" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TimeOffFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain width="25%" align=center>total days after increase<br><input type="text" size="1" maxlength="3" value="<% If say = "edit" Then %><%= GetBenefits("TimeOffFullDaysIncreased")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsTimeOffFullDaysIncreased" onchange="checkForWholeNumber(this.value); equalsLessThan101(this.value);"></td>
					</tr>
					<tr>
						<td align=center valign=bottom>&nbsp;<select name="frmBenefitsTimeOffFullNExempt" size=1 class="formMain" ID="Select17" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TimeOffFullNExempt") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center" width="30%">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table27">
					<tr>
						<td class=formMain align=center valign=bottom>&nbsp;Offered<br><select name="frmBenefitsTimeOffPart" size=1 class="formMain" ID="Select18" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TimeOffPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain width="25%" align=center>total days after increase<br><input type="text" size="1" maxlength="3" value="<% If say = "edit" Then %><%= GetBenefits("TimeOffPartDaysIncreased")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsTimeOffPartDaysIncreased" onchange="checkForWholeNumber(this.value); equalsLessThan101(this.value);"></td>
					</tr>
					<tr>
						<td align=center valign=bottom>&nbsp;<select name="frmBenefitsTimeOffPartNExempt" size=1 class="formMain" ID="Select19" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TimeOffPartNExempt") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=TimeOffSickFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Paid Time Off (Sick Time) Per Employee</td>
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table34">
					<tr>
						<td align=center valign=bottom>&nbsp;<select name="frmBenefitsTimeOffSickFull" size=1 class="formMain" ID="Select20" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TimeOffSickFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td align=center valign=bottom>&nbsp;<select name="frmBenefitsTimeOffSickPart" size=1 class="formMain" ID="Select21" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TimeOffSickPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
...
-->
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=ProfDuesFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Agency paid Professional Dues Per Employee&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Conferences, etc.)</td>			
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table38">
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsProfDuesFull" size=1 class="formMain" ID="Select22" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("ProfDuesFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain width="75%" align=center colspan="2">avg $ amount per employee&nbsp;<input type="text" size="2" maxlength="5" value="<% If say = "edit" Then %><%= GetBenefits("ProfDuesFullAmount")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsProfDuesFullAmount" onchange="checkForWholeNumber(this.value)"></td>
					</tr>
					</table>
				</td>
				<td class="formMain" align="center">
					...
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsProfDuesPart" size=1 class="formMain" ID="Select23" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("ProfDuesPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain width="75%" align=center colspan="3">avg $ amount per employee&nbsp;<input type="text" size="2" maxlength="5" value="<% If say = "edit" Then %><%= GetBenefits("ProfDuesPartAmount")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsProfDuesPartAmount" onchange="checkForWholeNumber(this.value)"></td>
					</tr>
					</table>
				</td>
			</tr>			
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=RetirementFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Agency paid Pension Plan per &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;employee</td>			
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table40">
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsRetirementFull" size=1 class="formMain" ID="Select24" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("RetirementFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsRetirementPart" size=1 class="formMain" ID="Select25" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("RetirementPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=403BFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;403 B per employee</td>			
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table42">
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefits403BFull" size=1 class="formMain" ID="Select26" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("403BFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain align=center valign=bottom>Employer Contribution<!--<input type="text" size="1" maxlength="3" value=" <% If say = "edit" Then %><%= GetBenefits("403BFullContrib")%><% Else %>0<% End If %>" class="formMain" name="frmBenefits403BFullContrib">-->
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefits403BPart" size=1 class="formMain" ID="Select27" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("403BPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain align=center valign=bottom>Employer<br>Contribution<!--<input type="text" size="1" maxlength="3" value=" <% If say = "edit" Then %><%= GetBenefits("403BPartContrib")%><% Else %>0<% End If %>" class="formMain" name="frmBenefits403BPartContrib">-->
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=TelecommFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Telecommuting per employee</td>			
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table44">
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsTelecommFull" size=1 class="formMain" ID="Select28" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TelecommFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain align=center valign=bottom># of employees<br><input type="text" size="1" maxlength="3" value="<% If say = "edit" Then %><%= GetBenefits("TelecommFullCount")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsTelecommFullCount" onchange="checkForWholeNumber(this.value); equalsLessThan101(this.value);"></td>
						<td class=formMain align=center>% of employee<br>population<br><input type="text" size="1" maxlength="3" value="<% If say = "edit" Then %><%= GetBenefits("TelecommFullPrcnt")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsTelecommFullPrcnt" onchange="checkForWholeNumber(this.value); equalsLessThan101(this.value);"></td>
					</tr>
					</table>
				</td>
				<td class="formMain" align="center">
					...
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsTelecommPart" size=1 class="formMain" ID="Select29" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TelecommPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<td class=formMain align=center valign=bottom># of employees<br><input type="text" size="1" maxlength="3" value="<% If say = "edit" Then %><%= GetBenefits("TelecommPartCount")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsTelecommPartCount" onchange="checkForWholeNumber(this.value); equalsLessThan101(this.value);"></td>
						<td class=formMain align=center>% of employee<br>population<br><input type="text" size="1" maxlength="3" value="<% If say = "edit" Then %><%= GetBenefits("TelecommPartPrcnt")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsTelecommPartPrcnt" onchange="checkForWholeNumber(this.value); equalsLessThan101(this.value);"></td>
					</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=TuitionFull" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Tuition Reimbursement per employee</td>			
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table46">
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsTuitionFull" size=1 class="formMain" ID="Select30" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TuitionFull") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<td class="formMain" align="center">
					...
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsTuitionPart" size=1 class="formMain" ID="Select31" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("TuitionPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
				...
				<tr>
				<td class="formMain" width="40%">
					<a href="../helpfiles/surveyhelp.asp?HelpID=Professional Development Budget" onclick="NewWindow(this.href,'name','600','450','yes');return false;"><img src="../images/qmarksmall.gif" alt="" width="15" height="16" border="0"></a>&nbsp;Professional Development Budget per employee</td>			
				<td class="formMain" align="center">
					<table width="100%" border="0" cellspacing="0" cellpadding="1" ID="Table48">
				<tr>
				    <td align=left valign=bottom>&nbsp;<select name="frmBenefitsProfDevBudgetFull" size=1 class="formMain" ID="Select33" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
							   <option value="true"<%If GetBenefits("ProfDevBudgetFull") then%> Selected<% End If %>  >Yes</option>
						       <option value="false"<%If not GetBenefits("ProfDevBudgetFull") then%> Selected<% End If %> >No</option>
							<%Else%>
									<option value="selected">Offered?</option>
									<option value="true">Yes</option>
									<option value="false">No</option>
						...
						<!--<td class=formMain width="25%" align=center><input type="checkbox" class="formMain" name="frmBenefitsTuitionPart" value="1"  <% If say = "edit" Then %><% if GetBenefits("TuitionPart")=true then%>checked="true"<% end if %><% end if %> onclick="CheckForOffer(this.form)"</td>-->
						<!--<td class=formMain width="25%" align=center><input type="checkbox" class="formMain" name="frmBenefitsTuitionPartPaid" value="1"  <% If say = "edit" Then %><% if GetBenefits("TuitionPartPaid")=true then%>checked="true"<% end if %><% end if %></td>-->
						<td class=formMain width="75%" align=center colspan="3">Maximum $ paid<br><input type="text" size="2" maxlength="5" value="<% If say = "edit" Then %><%= GetBenefits("ProfDevBudgetFullAmount")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsProfDevBudgetFullAmount" onchange="checkForWholeNumber(this.value)"></td>
					</tr>
					</table>
				</td>
				<td class="formMain" align="center">
					...
					<tr>
						<td align=left valign=bottom>&nbsp;<select name="frmBenefitsProfDevBudgetPart" size=1 class="formMain" ID="Select32" onchange="CheckForOffer(this.form)">
							<%If say = "edit" Then%>
									<%If GetBenefits("ProfDevBudgetPart") then%>
										<option value="true">Yes</option>
										<option value="false">No</option>
									<%else%>
										<option value="false">No</option>
						...
						<!--<td class=formMain width="25%" align=center><input type="checkbox" class="formMain" name="frmBenefitsTuitionPart" value="1"  <% If say = "edit" Then %><% if GetBenefits("TuitionPart")=true then%>checked="true"<% end if %><% end if %> onclick="CheckForOffer(this.form)"</td>-->
						<!--<td class=formMain width="25%" align=center><input type="checkbox" class="formMain" name="frmBenefitsTuitionPartPaid" value="1"  <% If say = "edit" Then %><% if GetBenefits("TuitionPartPaid")=true then%>checked="true"<% end if %><% end if %></td>-->
						<td class=formMain width="75%" align=center colspan="3">Maximum $ paid<br><input type="text" size="2" maxlength="5" value="<% If say = "edit" Then %><%= GetBenefits("ProfDevBudgetPartAmount")%><% Else %>0<% End If %>" class="formMain" name="frmBenefitsProfDevBudgetPartAmount" onchange="checkForWholeNumber(this.value)"></td>
					</tr>
					</table>
				</td>	
	    </tr>									
