...
If Request("status") = "addNew" Then
	...
	If(numberOfExisting = 0) Then
		...
		RST("TotalAssets") = FormatCurrency(TotalAssets)
			...
			Liabilities = Int(Request("frmExpensesLiabilitiesShort")) _
			+ Int(Request("frmExpensesLiabilitiesLong"))
			
			TotalLiabNetAssets = Int(Request("frmExpensesLiabilities")) _
			+ Int(Request("frmExpensesSurplus_NetAssets"))
			
		RST("LiabilitiesShort") = FormatCurrency(Request("frmExpensesLiabilitiesShort")) 'new aai 2008
		RST("LiabilitiesLong") = FormatCurrency(Request("frmExpensesLiabilitiesLong")) 'new aai 2008
		RST("Liabilities") = FormatCurrency(Liabilities)		
	...
	benefitYear	= Int(Request("Year"))
	IF benefitYear < 2007 Then
...
function addEmUp() 
{
	...
	var box5 = Number(document.frmExpenses.frmExpensesRent.value)
...
function AddUpLiabilities()
{
	...
	var box3 = Number(document.frmExpenses.frmExpensesLiabilitiesShort.value)
	var box4 = Number(document.frmExpenses.frmExpensesLiabilitiesLong.value)

	var boxtotal = box3 + box4
	document.frmExpenses.frmExpensesLiabilities.value = boxtotal
...
//	}
	...
	// Recalculate assets and liabilities and check that total assests = total liabilities and net assests
	var assets = Number(document.frmExpenses.frmExpensesCashInvestments.value) + Number(document.frmExpenses.frmExpensesReceivables.value) + Number(document.frmExpenses.frmExpensesAllOtherAssets.value)
	document.frmExpenses.frmExpensesTotalAssets.value = assets

	var liab = Number(document.frmExpenses.frmExpensesLiabilitiesShort.value) + Number(document.frmExpenses.frmExpensesLiabilitiesLong.value)
	document.frmExpenses.frmExpensesLiabilities.value = liab
	var liabAssets = liab + Number(document.frmExpenses.frmExpensesSurplus_NetAssets.value)
	document.frmExpenses.frmExpensesTotalLiabNetAssets.value = liabAssets
	
	if (assets != liabAssets)
	{
		form.frmExpensesLiabilitiesShort.focus();
...
%>
	...
	<tr>
		<td colspan="6" align="center" class="formSubheadbold"align="center">BBBS - <font color="#ff0000"><strong><%= y %></strong></font> Annual Agency Information (AAI)</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="formMainRightJ" width="24%">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("RentOccupancy") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesRent" onFocus="addEmUp();" onchange="checkForInteger(this.value);"></td>
	...
	<tr>
			<td colspan="6" class="formHeaderSmall"><strong>BALANCE SHEET<br>(as of December 31, <%=Y%>)</strong></td>
		</tr>				
		...
		<tr>
			...
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("CashInvestments") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesCashInvestments" onFocus="AddUpAssets();" onchange="checkForInteger(this.value);"></td>			
		</tr>
		<tr>
			<td class="formMain" width="80%" colspan="5">Receivables:</td>
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("Receivables") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesReceivables" onFocus="AddUpAssets();" onchange="checkForInteger(this.value);"></td>						
		</tr>		
		<tr>
			<td class="formMain" width="80%" colspan="5">All Other Assets:</td>
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("AllOtherAssets") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesAllOtherAssets" onFocus="AddUpAssets();" onchange="checkForInteger(this.value);"></td>									
		</tr>
		<tr>
			<td class="formMain" width="80%" colspan="5"  bgcolor="#c0c0c0"><strong>TOTAL ASSETS:</strong></td>
			<td class="formMainRightJ" width="24%" bgcolor="#c0c0c0">$&nbsp;<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("TotalAssets") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesTotalAssets" onFocus="AddUpAssets();" onchange="AddUpAssets();" readonly><br><span class="formSubHead">calculated by system</span></td>					
		</tr>	
		<TR>
		...
		<tr>
			...
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("LiabilitiesShort") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesLiabilitiesShort" onFocus="AddUpLiabilities();" onchange="checkForInteger(this.value);" ID="Text1"></td>						
		</tr>
		<tr>
			<td class="formMain" width="80%" colspan="5">Long Term Liabilities:</td>
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("LiabilitiesLong") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesLiabilitiesLong" onFocus="AddUpLiabilities();" onchange="checkForInteger(this.value);" ID="Text2"></td>						
		</tr>
		<tr>
			<td class="formMain" width="80%" colspan="5">Total Liabilities:</td>
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("Liabilities") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesLiabilities" onFocus="AddUpLiabilities();" onchange="addUpLiabilities();" readonly ID="Text3"><br><span class="formSubHead">calculated by system</span></td>
		</tr>		
		<tr>
			<td class="formMain" width="80%" colspan="5">Surplus/Net Assets:</td>
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("Surplus_NetAssets") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesSurplus_NetAssets" onFocus="AddUpLiabilities();" onchange="checkForInteger(this.value);"></td>			
		</tr>		
		<tr>
	...
	<tr>
		...
		<%If Y<2007 Then%>
			...
			<tr>
				<td class="formMain" colspan="5" align="left"><em>Must Total 100%.  Mentoring expenses include expenses for Community Based, School Based, and Other Site Based programs.  Non-Mentoring programs are services not based on a match relationship, such as camps or educational programs.</em></td>
			</tr>			
			<tr>
		...
		<%End IF%>	
<!-- This is commented on during development of 2007 AAI forms, because benefits are collected in a separate "Benefits" form.-->
		<%If Y<2007 Then%>
			<tr>
			...
			<%End IF%>									
			<!--End of 2007 AAI comment update  -->	
			</table>
		</td>
