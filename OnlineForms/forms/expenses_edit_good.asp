...
%>
	...
	<tr>
		<td class="formMain" colspan="4">&nbsp;</td>
	...
	<tr>
		...
		<tr>
			...
			<td class="formMainRightJ" width="20%">$<input type="text" class="formMain" size="10" maxlength="25" value="<% If say = "edit" Then %><%= GetExpenses("Liabilities") %><% Else %>0<% End If %>" class="formMain" name="frmExpensesLiabilities" onFocus="AddUpLiabilities();" onchange="checkForInteger(this.value);"></td>						
		</tr>		
		<tr>
