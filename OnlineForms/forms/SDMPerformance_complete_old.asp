...
<A class = "formmain" href="SDMperformance_complete_printable.asp?y=<%= Request("y") %>&m=<%= Request("m")%>&printform='Yes'&id=<%= GetPerformance("PerformanceID")%>" onclick="NewWindow(this.href,'name','600','400','yes');return false;"><img src="../images/print_icon.gif" alt="" width="34" height="34" border="0">Print This Form</a>
