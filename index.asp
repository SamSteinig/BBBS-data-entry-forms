...
<html>
<head>
	<title>BBBS :: Surveys & Reports</title>
	...
	<TR><!-- left side content cell -->
		...
		<TD VALIGN="top" WIDTH="88%"><!-- search table -->
			<TABLE WIDTH="549" BORDER="0" CELLPADDING="0" CELLSPACING="0">
				...
				<TR>
					<TD VALIGN="top"><IMG height=10 src="../media/images/spacer.gif" width=1 border=0><STRONG><FONT face=Verdana color=#000099 size=4><u>Please Note: These Pages Have Moved!</u></FONT></STRONG></TD>		
				</TR>
				
				<TR>
					<TD VALIGN="top" CLASS="text">
						<P><BR><BR><a href="../MyAgency/ads.asp" class="topstory">The ADS/Monthly Surveys Have Moved to Your MY AGENCY SECTION. Please Update Your Bookmarks!</a></P>
						<P><a href="../programs/poe.asp" class="topstory">The Program Evaulation Surveys Have Moved to the MY AGENCY SECTION. Please Update Your Bookmarks!</a></P>
						<P><a href="reports.asp" class="story">Click here for 2003 Reports</a></P>
					</TD>		
				</TR>
